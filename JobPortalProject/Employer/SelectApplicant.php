...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    mysqli_stmt_close($stmtJobSeekerEmail);
        ...
        // Compose the email
            ...
            $mail->isHTML(true);
            $mail->Subject = 'Congratulations! Your Application Has Been Selected';
            $mail->Body = "Congratulations! Your application for the job titled '$jobTitle' has been selected.<br>";
            ...
            $query = "UPDATE applications SET status = 1 WHERE application_id = ?";
            $stmt = mysqli_prepare($conn, $query);
            mysqli_stmt_bind_param($stmt, "i", $applicationId);
            mysqli_stmt_execute($stmt);


            $notificationMessage = "Your Application For '$jobTitle' Has Been Selected. Please Check Your Email.";
        ...
        header('Location: Applicants.php?applicantselected=1');
        exit();
    } else {
