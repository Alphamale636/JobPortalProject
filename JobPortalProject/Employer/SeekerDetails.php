...
<html lang="en">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        var deleteLink = document.getElementById("selectLink");

        deleteLink.addEventListener("click", function (e) {
            e.preventDefault(); // Prevent the default link behavior

            Swal.fire({
                title: 'Are You Sure You Want Select This Candidate?',
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = "POST";
                    form.action = "SelectSeeker.php";

                    var userInput = document.createElement("input");
                    userInput.type = "hidden";
                    userInput.name = "user_id";
                    userInput.value = "<?php echo $userId; ?>";

                    var employerInput = document.createElement("input");
                    employerInput.type = "hidden";
                    employerInput.name = "employerUsername";
                    employerInput.value = "<?php echo $employerUsername; ?>";
