...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/ViewEmployer.css">
            ...
            <div class="container">
                <div class="navigation">
                        ...
                        <span class="nav-item">Dashboard</span>
                            ...
                            <li class= "menu">
                                <a href="ProfileSection.php" class="menu"> 
                    ...
                    <div class="details">
                        <div class="Profile">
                            <div class="ProfileHeader">
                                <ion-icon name="person-outline"></ion-icon> <h2>EMPLOYER DETAILS</h2>
