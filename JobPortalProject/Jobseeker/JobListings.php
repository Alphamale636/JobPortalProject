...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/joblistings.css">
            ...
            <div class="main">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                        ...
                        if (empty($searchValue) && empty($jobTypeValue)) {
                            ...
                            echo '<script>window.location.href = "JobListings.php";</script>';
                        } else {
...
//sweetalert
 ...
 // SweetAlert2
     if (window.location.search.indexOf('alreadyexist') > -1) {
        Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Application Already Submitted for This Job',
        });
        setTimeout(function () {
            window.location.href = 'JobListings.php'; // Redirect to the final target page
